        ...
        <div class="row align-items-center">
            <div class="col-12" data-aos="fade">
                ...
                <form action="{{ route('alljobs') }}">
                                ...
                                <div class="col-md-6 mb-3 mb-md-0">
                                    <div class="input-wrap">
                                        ...
                                        <input type="text" name="address"
                                            class="mr-3 form-control border-0 px-4" placeholder="city, province or region" required="">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p class="small">or browse by category: <a href="#" class="category">Category
                                    #1</a> <a href="#" class="category">Category #2</a></p>
                        </div>
                    </div>
